...
def upgrade() -> None:
    ...
    sa.Column('game_type', postgresql.ENUM('TICTACTOE', 'CHESS', 'CONNECT_FOUR', 'HEX', name='gametype', create_type=False), nullable=False),
    ...
    op.execute(
        f"INSERT INTO arenas (id, name, description, game_type, config, is_active, created_at, updated_at) VALUES "
